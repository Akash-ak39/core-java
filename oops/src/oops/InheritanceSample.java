...
public class InheritanceSample {
	...
	public static void main(String[] args) {
		 ...
		 * 4. If you have to create a object of the super class then you need to inherit the super class with sub class
		 ...
		 * 7. All the public, no modifier and protected properties of super class will be visible in sub class
		 *
		 */
