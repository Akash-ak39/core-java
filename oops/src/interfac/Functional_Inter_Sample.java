...
public class Functional_Inter_Sample {
	public static void main(String[] args) {
		...
		// Method Referencing...
		FInterOne one = Functional_Inter_Sample::mymethod;
		one.met();
		...
		// Method referencing
		FInterTwo two = new Functional_Inter_Sample()::mymethod2;
		value = two.met();
		...
		// Method Referencing
		FInterThree three = new Functional_Inter_Sample()::mymethod3;
		val = three.met(1000, "method ref");
		System.out.println("value...:" + val);
		// Lambda
		FInterThree threeLambda = (int num, String str) -> {
			return num + ":" + str;
		};
		...
		// Method Referencing
		FInterFour four = new Functional_Inter_Sample()::mymethod4;
